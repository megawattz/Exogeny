...
VERSION_INFO_LONG="project:$PROJECT_STRING branch:$BRANCH_STRING hash:$REVISION_STRING tag:$VERSION_STRING date:$DATE_STRING"
VERSION_INFO_STRING="$PROJECT_STRING $BRANCH_STRING $REVISION_STRING $VERSION_STRING $DATE_STRING"
