...
def resolve_parameter(name, value, options):
    ...
    if (name == "sun_brightness"):
        bright = randomlist([2, 3, 4, 5, 6, 7, 8, 9])
...
LifeForms = ['Gaseous','Plant','Blob','Fungoid','Cephalopoid','Aquatic','Human','Aerial','Humanoid','Insectoid','Reptilian','Mammalian']
...
def civilization(identity, options):
    civilization = {
        ...
        # generated assets
        "infrastructure": options.get("infrastructure") or 1,
        "manufactured": options.get("manufactured") or 1,
        "services": options.get("services") or 1,
        "entertainment": options.get("entertainment") or 1,
        "woo": options.get("woo") or 1,
        "happiness": options.get("happiness") or 1,
        "population": options.get("population") or 1,
        "tritanium44": options.get("tritanium44") or 0,

        # tech levels
        "bio":options.get("bio") or 1,
        "energy":options.get("energy") or 1,
        "information":options.get("information") or 1,
        "engineering":options.get("engineering") or 1,
        "science":options.get("science") or 1,
        "transport":options.get("transport") or 1,
        "social":options.get("social") or 1,
        "warfare":options.get("warfare") or 1,
        "economic":options.get("econonomic") or 1,
        "spiritual":options.get("spiritual") or 2,
        "art":options.get("art") or 2,
    }
    return civilization
